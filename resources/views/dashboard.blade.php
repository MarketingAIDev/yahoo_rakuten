        ...
        <div class="col-md-8">
            @if(Auth::user()->role == 'producer')
                <div class="m-3">
                    ...
                    <span class="badge" style="background: #7b324b">{{__('messages.recruitment.status.collecting')}}</span>
            ...
            @else
                <div class="m-3">
                    ...
                    <span class="badge" style="background: #219ff3">{{__('messages.applicants.status.abandoned')}}</span>
{{--                    <span class="badge" style="background: #90ac11">{{__('messages.applicants.status.fired')}}</span>--}}
                    <span class="badge" style="background: #ac3d11">{{__('messages.applicants.status.finished')}}</span>
                </div>
            @endif
            <div id='calendar'></div>
        </div>
