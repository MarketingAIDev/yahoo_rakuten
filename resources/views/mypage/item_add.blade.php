          ...
          <div class="tab-content" id="custom-tabs-four-tabContent">
            <div class="tab-pane fade show active" id="custom-tabs-common" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
              <form class="form-horizontal">
                <div class="card-body" style="padding:0px">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="master_code" name="master_code" placeholder="マスターコード">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="jan_code" name="jan_code" placeholder="商品名">
                    </div>
                  </div>                  
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" id="group_set" name="group_set">
                        ...
                        <option value="2">グループ 2</option>
                        <option value="3">グループ 3</option>
                        <option value="4">グループ 4</option>
                        <option value="5">グループ 5</option>
                        <option value="6">グループ 6</option>
                        <option value="7">グループ 7</option>
                        <option value="8">グループ 8</option>
                        <option value="9">グループ 9</option>
                        <option value="10">グループ 10</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td>共通</td>
                          <td><input type="number" class="form-control" id="common_low_price" name="common_low_price" placeholder="0" style="width:100%" value="0"></td>
                          <td><input type="number" class="form-control" id="common_pro_price" name="common_pro_price" placeholder="0" style="width:100%" onchange="common_low_price_func()" value="0"></td>
                          <td><input type="number" class="form-control" id="common_normal_price" name="common_normal_price" placeholder="0" style="width:100%" onchange="common_low_price_func()" value="0"></td>
                        ...
                        <tr>
                          <td>楽天</td>
                          <td><input type="number" class="form-control" id="rakuten_low_price" name="rakuten_low_price" placeholder="0" style="width:100%" value="0"></td>
                          <td><input type="number" class="form-control" id="rakuten_pro_price" name="rakuten_pro_price" placeholder="0" style="width:100%" onchange="rakuten_low_price_func()" value="0"></td>
                          <td><input type="number" class="form-control" id="rakuten_normal_price" name="rakuten_normal_price" placeholder="0" style="width:100%" onchange="rakuten_low_price_func()" value="0"></td>
                        ...
                        <tr>
                          <td>ヤフー</td>
                          <td><input type="number" class="form-control" id="yahoo_low_price" name="yahoo_low_price" placeholder="0" style="width:100%" value="0"></td>
                          <td><input type="number" class="form-control" id="yahoo_pro_price" name="yahoo_pro_price" placeholder="0" style="width:100%" onchange="yahoo_low_price_func()" value="0"></td>
                          <td><input type="number" class="form-control" id="yahoo_normal_price" name="yahoo_normal_price" placeholder="0" style="width:100%" onchange="yahoo_low_price_func()" value="0"></td>
              ...
              <form class="form-horizontal">
                ...
                <div class="card-body" style="padding:0px">
                  <div class="form-group row">
                    <input type="checkbox" data-toggle="switchbutton" checked id="ec_kind" data-onlabel="Rakuten" data-offlabel="Yahoo" data-onstyle="success" data-offstyle="danger" width="250px">
                  </div>
                  <div class="form-group row">
                    価格調査方法
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10" style="padding-top: calc(0.375rem + 1px);">
                      <div class="col-sm-12 clearfix">
                        <div class="col-sm-12 icheck-primary d-inline">
                          <input type="radio" id="point_true" name="point" value="1" checked="">
                        ...
                        <div class="col-sm-12 icheck-danger d-inline">
                          <input type="radio" id="point_false" name="point"  value="0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10" style="padding-top: calc(0.375rem + 1px);">
                      <div class="col-sm-12 form-group clearfix">
                        <div class="col-sm-12 icheck-primary d-inline">
                          <input type="radio" id="deli_true" name="deli" value="1" checked="">
                          <label for="deli_true">
                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                            含まない
                            </font></font>                                          
                        ...
                        <div class="col-sm-12 icheck-danger d-inline">
                          <input type="radio" id="deli_false" name="deli" value="0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10" style="padding-top: calc(0.375rem + 1px);">
                      <div class="col-sm-12 form-group clearfix">
                        <div class="col-sm-12 icheck-primary d-inline">
                          <input type="radio" id="free_deli_true" name="free_deli" value="1" checked="">
                        ...
                        <div class="col-sm-12 icheck-danger d-inline">
                          <input type="radio" id="free_deli_false" value="0" name="free_deli">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div>
                        <input type="text" class="form-control" id="tracking_shop" name="tracking_shop" placeholder="メモ">
                      </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div>
                        <input type="number" class="form-control" id="low_price" name="low_price" placeholder="調査下限価格">
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div>
                        <input type="text" class="form-control" id="out_keyword" name="out_keyword" placeholder="調査除外キーワード">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div>
                        <input type="text" class="form-control" id="survey_url" name="survey_url" placeholder="調査除外ショップURL">
                      </div>
              ...
              <form class="form-horizontal">
                <div class="card-body" style="padding:0px">
                  ...
                  <div class="form-group row" id="item_url_div">
                    ...
                    <div class="col-sm-10">
                      <div>
                        <input type="text" class="form-control" id="item_url" name="item_url" placeholder="商品管理番号（商品URL）">
                      </div>
                    </div>
                  </div>
                  <div class="row" id="tax_div">
                    ...
                    <div class="col-sm-10" style="padding-top: calc(0.375rem + 1px);">
                      <div class="col-sm-12 form-group clearfix">
                        <div class="col-sm-12 icheck-primary d-inline">
                          <input type="radio" id="tax_true" value="1" name="tax" checked="">
                          <label for="tax_true">
                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                            する
                            </font></font>                                          
                        ...
                        <div class="col-sm-12 icheck-danger d-inline">
                          <input type="radio" id="tax_false" value="0" name="tax">
                          <label for="tax_false">
                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                            しない
                            </font></font>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10" style="padding-top: calc(0.375rem + 1px);">
                      <div class="col-sm-12 form-group clearfix">
                        <div class="col-sm-12 icheck-primary d-inline">
                          <input type="radio" id="manager_true" name="manager" value="1" checked="">
                        ...
                        <div class="col-sm-12 icheck-danger d-inline">
                          <input type="radio" id="manager_false" value="0" name="manager">
