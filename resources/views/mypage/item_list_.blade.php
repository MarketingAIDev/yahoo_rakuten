				...
				<div class="card-body">
					<div class="tab-content" id="custom-tabs-four-tabContent">
						<div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
							<div class="row">										
								<div>
									<table class="table table-bordered" id="rakuten-table" border="1">
										<thead>
											<tr>
										...
										<tbody>
											...
											<tr data-product="{{$item['id']}}">
												...
												<td rowspan="2">{{$item['r_time_pattern']['yen']}}円</td>
												<td rowspan="2">{{$item['r_time_pattern']['pro']}}%</td>
												...
												<td rowspan="2" style="background: #eee; color: black;">{{$item["rakuten_now_price"] + $item['r_time_pattern']['yen']}}円</td>
												...
												<td rowspan="2" id="r_diff_<?=$item["id"]?>">{{$item["rakuten_now_price"] + $item['r_time_pattern']['yen'] - $item->r_real_low_price}}</td>
											</tr>
											<tr>
									...
									<table class="table table-bordered" id="yahoo-table">
										...
										<tbody>
											...
											<tr data-product="{{$item['id']}}">
												...
												<td rowspan="2">{{$item['y_time_pattern']['yen']}}円</td>
												<td rowspan="2">{{$item['y_time_pattern']['pro']}}%</td>
												<td rowspan="2" data-field="time-pattern" data-selected="">
													@foreach ($timepatterns as $pattern)
														@if ($pattern['display'])
												...
												<td rowspan="2" style="background: #eee; color: black;"></td>
												<td rowspan="2" style="background: #eee; color: black;">{{$item["yahoo_now_price"] + $item['y_time_pattern']['yen']}}円</td>
												...
												<td rowspan="2" id="y_diff_<?=$item["id"]?>">{{$item["rakuten_now_price"] + $item['r_time_pattern']['yen'] - $item->y_real_low_price}}</td>
											</tr>
											<tr>
...
@section("script")
	...
	<script>
		...
		const selectPattern = (e) => {
			...
			setInterval(timeTracking, 300000);
